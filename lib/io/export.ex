defmodule Plsm.IO.Export do
  ...
  def type_output(field) do
    case field do
      {name, type, primary_key} when primary_key != true and type == :integer ->
        four_space("field :#{name}, :integer\n")

      {name, type, primary_key} when primary_key != true and type == :decimal ->
        four_space("field :#{name}, :decimal\n")

      {name, type, primary_key} when primary_key != true and type == :float ->
        four_space("field :#{name}, :float\n")

      {name, type, primary_key} when primary_key != true and type == :string ->
        four_space("field :#{name}, :string\n")

      {name, type, primary_key} when primary_key != true and type == :date ->
